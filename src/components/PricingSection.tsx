...
const pricingTiers = [
  ...
  },
  {
    ...
    price: "По запросу",
    features: [
      "Ведущий + DJ весь вечер",
      "Эксклюзивный сценарий",
      "Шоу-программа на заказ",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-balance">
            Выберите <span className="text-primary">подходящий формат</span> для вашего праздника
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            От камерного торжества до грандиозной вечеринки — найдём формат под любой бюджет
          </p>
        </div>
          ...
          {pricingTiers.map((tier, index) => (
            ...
            >
              ...
              <CardContent>
                ...
                >
                  {tier.price === "По запросу" ? "Обсудить формат" : "Забронировать"}
                </QuoteFormDialog>
              </CardContent>
            </Card>
          ))}
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted-foreground">
            Все форматы включают <span className="text-primary font-semibold">индивидуальный сценарий</span> и{" "}
