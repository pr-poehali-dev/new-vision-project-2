...
const steps = [
  {
    icon: Lightbulb,
    title: "Обсуждаем ваш праздник",
    description:
      "Созваниваемся или встречаемся, слушаем ваши пожелания и рассказываем о форматах. Вместе выбираем стиль, программу и музыку. Никакого шаблонного подхода — только ваши идеи.",
    number: "01",
  },
  {
    icon: PaletteIcon,
    title: "Готовим сценарий",
    description:
      "Разрабатываем индивидуальный сценарий под ваш праздник: конкурсы, тосты, музыкальные блоки, сюрпризы. Согласовываем каждый момент — вы всегда в курсе программы.",
    number: "02",
  },
  {
    icon: Rocket,
    title: "Проводим незабываемо",
    description:
      "В день праздника приезжаем заранее, настраиваем оборудование и ведём программу на высшем уровне. Вы просто наслаждаетесь, мы берём все заботы на себя.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">заявки</span> до <span className="text-primary">праздника</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Три простых шага — и ваш праздник будет в надёжных руках. Мы делаем всё, чтобы вы ни о чём не беспокоились.
          </p>
        </div>
