...
const projects = [
  {
    ...
    description:
      "Торжество на 120 гостей в загородном комплексе. Авторский сценарий, живая музыка, DJ-сет до утра. Молодожёны до сих пор вспоминают этот вечер как лучший в жизни.",
